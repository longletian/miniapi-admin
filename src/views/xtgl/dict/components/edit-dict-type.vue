<template>
  <YModal ref="yModal" :title="$t('menu.xtgl.dict.type.edit')" :width="550">
    <a-form ref="formRef" direction="horizontal" :model="formData">
      <a-space direction="horizontal" :size="24">
        <a-row>
          <a-col>
            <a-form-item
              :label="$t('groupForm.form.dictName')"
              field="formData.dictName"
            >
              <a-input
                v-model="formData.dictName"
                :placeholder="$t('groupForm.form.dictName.placeholder')"
              >
              </a-input>
            </a-form-item>
          </a-col>
          <a-col>
            <a-form-item
              :label="$t('groupForm.form.dictCode')"
              field="formData.dictCode"
            >
              <a-input
                v-model="formData.dictCode"
                :placeholder="$t('groupForm.form.dictCode.placeholder')"
              >
              </a-input>
            </a-form-item>
          </a-col>

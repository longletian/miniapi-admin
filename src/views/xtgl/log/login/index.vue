          ...
          >
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                <a-form-item
                  field="loginIp"
                  :label="$t('searchTable.form.loginIp')"
                >
                  <a-input
                    v-model="formModel.loginIp"
                    :placeholder="$t('searchTable.form.loginIp.placeholder')"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
...
<script lang="ts" setup>
  ...
  const { t } = useI18n();
  const renderData = ref<LoginLogListDataDto[]>([]);
  ...
  const columns = computed<TableColumnData[]>(() => [
    ...
    // {
    //   title: t('searchTable.columns.browser'),
    //   dataIndex: 'browser',
    // },
    {
    ...
    {
      title: t('searchTable.columns.os'),
      dataIndex: 'os',
    },
    // {
    //   title: t('searchTable.columns.msg'),
    //   dataIndex: 'msg',
    // },
    {
      title: t('searchTable.columns.loginTime'),
      dataIndex: 'loginTime',
    },
    {
  ...
  const fetchData = async (
    ...
    setLoading(true);
    try {
      const { data } = await getPageLoginLogListData(params);
  ...
  const search = () => {
    fetchData({
      ...basePagination,
      ...formModel.value,
    } as unknown as LoginLogSearchParams);
  };
